  ...
  return (
    <div className="h-screen flex items-center justify-between p-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        <h1 className="xsm:text-4xl text-2xl font-bold md:text-6xl ">
          Happening Now
        </h1>
        ...
        <SignIn.Root>
          <Clerk.Connection
            name="google"
            className="bg-white text-black flex items-center justify-center w-72 p-2 rounded-full  gap-2 font-bold">
          ...
          <SignIn.Step name="start" className="flex flex-col gap-4">
            <Clerk.Field name="identifier" className="flex flex-col gap-2">
              <Clerk.Input
                ...
                placeholder="social-web@gmail.com"
              />
              <Clerk.FieldError className="text-red-300 text-sm" />
            </Clerk.Field>
            <SignIn.Action
              submit
              className="bg-iconBlue w-72 rounded-full p-2 text-white text-center font-bold ">
              Continue
            </SignIn.Action>
          </SignIn.Step>
            ...
            <SignIn.Strategy name="password">
              ...
              <div className="flex flex-col gap-2">
                ...
                <SignIn.Action
                  ...
                  className="mt-2 w-72 underline text-sm text-center">
                  Forgot Password?
                </SignIn.Action>
              </div>
            </SignIn.Strategy>
          ...
          <SignIn.Step
            ...
            <SignIn.SupportedStrategy name="reset_password_email_code">
              <span className=" text-black bg-white rounded-full text-center py-2 px-4 ">
                Reset Password
              </span>
            ...
            <SignIn.Action
              navigate="previous"
              className=" text-black bg-white rounded-full text-center py-2 px-4">
              Go back
            </SignIn.Action>
          </SignIn.Step>
          ...
          <div className="w-72 flex items-center gap-4">
            <div className="h-px border border-borderGray flex-grow"></div>
            <span className="text-textGrayLight"> or</span>
            <div className="h-px  flex-grow border border-borderGray"></div>
          </div>
          <Link
            href="/sign-up"
            className="bg-iconBlue w-72 rounded-full p-2 text-white text-center font-bold ">
